...
| `video-ads` | Turn a brief or a spine into upload-ready vertical videos and statics, checked automatically and through a publication gate, with a synthetic persona panel as the cold reader when no human is available | `ad-test-loop` |
